...
export interface ButtonSecondaryProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, 'children'> {
  /**
   * Button label text
   */
  label?: string
...
/**
 * Button Secondary component - Secondary button variant that adapts to the current brand theme
 * Based on ButtonSecondaryL component structure
 */
